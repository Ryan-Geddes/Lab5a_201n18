...
returns an array where the first element is the sum of those three numbers, the second element is the product 
of those three numbers,  and the third and fourth elements are strings that EXACTLY follow this example and use 
...
function multiplyArray(multArr) { 
    var mult = sumAndMultiply(multArr[0],multArr[1],multArr[2]);
    var answerArr = [mult[1], 'The numbers ' + multArr + ' have a product of ' + mult[1] + '.']
    return answerArr;
